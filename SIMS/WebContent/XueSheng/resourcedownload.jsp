...
<head>
    ...
    <title>资源下载</title>
    <meta name="description" content="下载,资源">
    <meta name="keywords" content="下载,资源">
                    ...
                    <h2>资源下载</h2>
                     <table class="table">
                     	...
                     	<tr>
                     		...
                     		<td><button onclick="javascript:window.location.href='downloadAction?id=' + ${res.id}">下载</button></td>
                     	</tr>
                     	</s:iterator>
                     </table>
                </article>
