	...
	<div class="wrapper">
		...
		<div class="wrapper2">
			...
			<section class="main-content">
				<article>
					<h2>修改周记<span><a href="${pageContext.request.contextPath}/XueSheng/studentAction_listZj">返回</a>
						</span></h2>
					<form action="" method="post">
						<table class="form-table">
							<tr>
								<td class="adjust-td">标题：</td>
								<td><input type="text" required name="zj.title" value="${zj.title}"></td>
							</tr>
							<tr>
								<td>描述：</td>
								<td><textarea name="zj.content" id="" cols="50" rows="10">${zj.content}</textarea>
								</td>
							</tr>
							<tr>
								<td></td>
