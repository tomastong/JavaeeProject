            ...
            <section class="main-content">
                <article>
                    ...
                    <ul class="article-list">
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/XueSheng/studentAction_seeInform?id=${inform.id}">${inform.title }</a><time><s:date name="date" format="yyyy/MM/dd "/></time>
                        </li>
                        </s:iterator>
                    </ul>
                </article>
