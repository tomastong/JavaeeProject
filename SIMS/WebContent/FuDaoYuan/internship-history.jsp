...
<body>
    <div class="wrapper">
        ...
        <div class="wrapper2">
            ...
            <section class="main-content">
                <article>
                	<h2>实习申请历史<span><a href="${pageContext.request.contextPath}/FuDaoYuan/assistantAction_listShiXiStudent">返回</a></span></h2>
                    <table class="easy-table">
                        ...
                        <tr>
                            ...
                            <td>${student.internshipDirection.status==1 ? '通过':'未过' }</td>
                            <td>
                ...
                <div class="pagination">
					<ul id="page"><c:forEach var="item" varStatus="status" begin="1" end="${pageModel.totalPages}" ><li><a 
							href="${pageContext.request.contextPath}/FuDaoYuan/assistantAction_listShiXiHistory?pageModel.pageNo=${status.index}" class="page-numbers">${status.index}</a></li></c:forEach></ul>
				</div>
            </section>
    ...
    window.onload = function() {
		...
		firstli.innerHTML = "<a href='${pageContext.request.contextPath}/FuDaoYuan/assistantAction_listShiXiHistory?pageModel.pageNo=${pageModel.pageNo-1}' class='page-numbers prev'>&laquo;上一页</a>";
		lastli.innerHTML = "<a href='${pageContext.request.contextPath}/FuDaoYuan/assistantAction_listShiXiHistory?pageModel.pageNo=${pageModel.pageNo+1}' class='page-numbers next'>下一页&raquo;</a>";
		spanli.innerHTML = "<span class='page-numbers next'>下一页&raquo;</span>";
		page.childNodes[curr - 1].innerHTML = "<a href='${pageContext.request.contextPath}/FuDaoYuan/assistantAction_listShiXiHistory?pageModel.pageNo=${pageModel.pageNo}' class='page-numbers current'>"+${pageModel.pageNo}+"</a>";;
		if (cnt != curr && cnt != 1) {
