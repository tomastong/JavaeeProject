...
<body>
			...
			<section class="main-content">
					...
					<table class="easy-table">
						...
						<s:iterator value="pageModel.list" var="student">
							<tr>
								...
								<td><button
										onclick="javascript:window.location.href='${pageContext.request.contextPath}/FuDaoYuan/assistantAction_seeShiXun?id=${student.id}'">修改</button>
								</td>
							</tr>
						</s:iterator>
					</table>
				...
				<div class="pagination">
					<ul id="page"><c:forEach var="item" varStatus="status" begin="1" end="${pageModel.totalPages}" ><li><a 
							href="${pageContext.request.contextPath}/FuDaoYuan/assistantAction_listShiXunStudent?pageModel.pageNo=${status.index}" class="page-numbers">${status.index}</a></li></c:forEach></ul>
				</div>
				</article>
			</section>
	...
	<script>
		window.onload = function() {
			...
			firstli.innerHTML = "<a href='${pageContext.request.contextPath}/FuDaoYuan/assistantAction_listShiXunStudent?pageModel.pageNo=${pageModel.pageNo-1}' class='page-numbers prev'>&laquo;上一页</a>";
			lastli.innerHTML = "<a href='${pageContext.request.contextPath}/FuDaoYuan/assistantAction_listShiXunStudent?pageModel.pageNo=${pageModel.pageNo+1}' class='page-numbers next'>下一页&raquo;</a>";
			spanli.innerHTML = "<span class='page-numbers next'>下一页&raquo;</span>";
			page.childNodes[curr - 1].innerHTML = "<a href='${pageContext.request.contextPath}/FuDaoYuan/assistantAction_listShiXunStudent?pageModel.pageNo=${pageModel.pageNo}' class='page-numbers current'>"+${pageModel.pageNo}+"</a>";;
			if (cnt != curr && cnt != 1) {
