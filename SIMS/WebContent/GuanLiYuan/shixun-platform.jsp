...
<body>
    <div class="wrapper">
        ...
        <div class="wrapper2">
            ...
            <section class="main-content">
                <article>
                    <h2>实训平台</h2>
                    <form action="${pageContext.request.contextPath}/GuanLiYuan/adminAction_addShiXunTime" method="post">
                        <div class="div-top-1">
    ...
    <script>
  		...
  		if(prompt==null || prompt ==""){
  			...
  			alert(prompt);
  			window.location.href="${pageContext.request.contextPath}/GuanLiYuan/adminAction_shixunPlatform";
  		}
    </script>
</body>
