    ...
    <div class="wrapper">
        ...
        <div class="wrapper2">
            ...
            <section class="main-content">
                <article>
                    <h2>添加辅导员<span><a href="${pageContext.request.contextPath}/GuanLiYuan/adminAction_listAssistant">返回</a></span></h2>
                    <form action="${pageContext.request.contextPath}/GuanLiYuan/adminAction_addAssistant" method="post" enctype="multipart/form-data">
                        <table class="easy-table content-layout table-block">
                            ...
                            <tr>
                                <td>性别：</td>
                                <td>
                                    <input type="radio" value="男" name="assistant.sex" checked>男&nbsp;
                                    <input type="radio" value="女" name="assistant.sex">女</td>
                            </tr>
                            <tr>
                                <td>联系方式：</td>
                                <td>
                                    <input type="text" name="assistant.tel">
                                </td>
                            </tr>
                            <tr>
                                <td>负责年级：</td>
                            ...
                            <tr>
                                <td>工号：</td>
                                <td>
                                    <input type="text" name="assistant.jobNum">
                                </td>
                            </tr>
                            <tr>
                                <td>家庭住址：</td>
                                <td>
                                    <input type="text" name="assistant.address">
                                </td>
                            </tr>
                            <tr>
                                <td>上传头像：</td>
