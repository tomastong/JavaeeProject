    ...
    <div class="wrapper">
        ...
        <div class="wrapper2">
            ...
            <section class="main-content">
                <article>
                    <h2>添加教师<span><a href="${pageContext.request.contextPath}/GuanLiYuan/adminAction_listTeacher">返回</a></span></h2>
                    <form action="${pageContext.request.contextPath}/GuanLiYuan/adminAction_addTeacher" method="post" enctype="multipart/form-data">
                        <table class="easy-table content-layout table-block">
                            ...
                            <tr>
                                <td>性别：</td>
                                <td>
                                    <input type="radio" value="男" name="teacher.sex" checked>男&nbsp;
                                    <input type="radio" value="女" name="teacher.sex">女</td>
                            </tr>
                            <tr>
                            	<td>年龄</td>
                            	<td><input type="number" name="teacher.age"></td>
                            </tr>
                            <tr>
                                <td>联系方式：</td>
                                <td>
                                    <input type="text" name="teacher.tel">
                                </td>
                            </tr>
                            <tr>
								<td>所属年级：</td>
                            ...
                            <tr>
                                <td>工号：</td>
                                <td>
                                    <input type="text" name="teacher.jobNum">
                                </td>
                            </tr>
                            <tr>
                                <td>家庭住址：</td>
                                <td>
                                    <input type="text" name="teacher.address">
                                </td>
                            </tr>
                            <tr>
                                <td>上传头像：</td>
