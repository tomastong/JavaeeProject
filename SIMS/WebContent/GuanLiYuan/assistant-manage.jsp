    ...
    <div class="wrapper">
        ...
        <div class="wrapper2">
            ...
            <section class="main-content">
                <article>
                	<h2>导员管理<span><a href="add-assistant.jsp">添加导员</a></span></h2>
                     <table class="easy-table">
                         ...
                         <s:iterator value="list" var="assistant">
                         <tr>
                             <td>${assistant.jobNum}</td>
                             <td>${assistant.name}</td>
                             <td>${assistant.grade.name}</td>
                             <td>${assistant.tel}</td>
                             <td><button onclick="javascript:window.location.href='adminAction_seeAssistant?id='+${assistant.id}+'&flag=alter'">修改</button></td>
                             <td><button onclick="javascript:window.location.href='adminAction_delAssistant?id='+${assistant.id}">删除</button></td>
                             <td><button onclick="javascript:window.location.href='adminAction_seeAssistant?id='+${assistant.id}+'&flag=see'">查看</button></td>
                         </tr>
                         </s:iterator>
                     </table>
                </article>
