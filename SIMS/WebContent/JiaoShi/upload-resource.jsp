    ...
    <div class="wrapper">
        ...
        <div class="wrapper2">
            ...
            <section class="main-content">
                <article>
                    <h2>资源管理</h2>
                    <form action="${pageContext.request.contextPath}/JiaoShi/teacherAction_uploadFile" method="post" enctype="multipart/form-data">
                        <div class="div-top-1">
							上传资料： <input type="file" name="upload" class="minish">
                            <button type="submit" class="control-button">提交</button>
                        </div>
                    </form>
                </article>
            </section>
