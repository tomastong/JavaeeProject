...
<body>
	<div class='fix_wrapper' style="margin-top:50px;margin-right:100px"> 
		<h2>添加类别</h2>
		<aside class='form'>
		<form accept-charset="UTF-8" action="${pageContext.request.contextPath}/gcate.do?method=add" method="post">
					<div class='component'>
						<label for="category">类别:</label> <input class="text_field_280"
							id="category" name="category" type="text" placeholder="Category" style="height:30px"/>
					</div>
