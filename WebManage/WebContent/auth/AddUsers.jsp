...
<body>
	<div class='fix_wrapper' style="margin-top:50px;margin-right:100px"> 
		<h2>添加用户</h2>
		<aside class='form'>
		<form accept-charset="UTF-8" action="${pageContext.request.contextPath}/users.do?method=add" method="post">
					<div class='component'>
						<label for="Email">用户名:</label> <input class="text_field_280"
							id="username" name="username" type="text" placeholder="Username" style="height:30px"/>
					</div>
					<div class='component'>
						<label for="password">密&nbsp;&nbsp;码:</label> <input class="text_field_280"
							id="password" name="password" type="password" placeholder="Password" style="height:30px"/>
					</div>
