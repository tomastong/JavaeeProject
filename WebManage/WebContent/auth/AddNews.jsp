...
<body>
	<div class='fix_wrapper' style="margin-top:50px;margin-right:100px"> 
		<h2>新闻添加</h2>
		<aside class='form'>
		<form accept-charset="UTF-8" action="${pageContext.request.contextPath}/news.do?method=add" method="post">
					<div class='component'>
						<label for="NewsTitle">标题:</label> <input class="text_field_280"
							id="NewsTitle" name="NewsTitle" type="text" placeholder="Enter Title" style="height:30px" />
					</div>
					<div class='component'>
						<label for="NewsAuthor">作者:</label> <input class="text_field_280"
							id="NewsAuthor" name="NewsAuthor" readonly="readonly" value="${sessionScope.name}" type="text" placeholder="Enter Name" style="height:30px"/>
					</div>
					<div class='component'>
						<label for="NewsContent">内容:</label> <textarea class="text_field_280"
							id="NewsContent" name="NewsContent" placeholder="Enter Content" style="resize:none" rows="8" ></textarea>
					</div>
