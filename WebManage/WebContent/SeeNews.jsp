...
<body>
	<div class='fix_wrapper' style="margin-top: 50px; margin-right: 100px">
		...
		<div class="smallcontain" style="border: 1px solid #ccc">
			...
			<div class="page">
				<h2><a href="#" onclick="moreNews()">点击查看更多新闻信息！</a></h2>
			</div>
		</div>
	</div>
	<script type="text/javascript">
	    function see(id){
    		window.location = "${pageContext.request.contextPath}/PreNews.do?method=justSee&id="+id;
	    }
	    function moreNews(){
    		window.location = "${pageContext.request.contextPath}/PreNews.do?method=seeAll";
	    }
	</script>
</body>
</html>