...
<div id="headdiv" class="page-header" contenteditable="true">
	<h2 class="headfont" style="margin-right:300px;">WelcomeTo新闻系统!</h2><h4 class="headfont" style="margin-top:20px"><div id="disptime" style="float:left"></div>&nbsp;&nbsp; <font color="4F87D4"><input type="button" class="button small" onclick="window.open('Login.jsp')"  value="登录"></a></font>,欢迎您!</h4>
</div>
</body>
